...
$(document).ready(function () {
  ...
  $("#daterange-btnCotizaciones").daterangepicker(
    ...
    function (start, end) {
      ...
      console.log(fechaFinalCotizaciones, fechaInicialCotizaciones)
  ...
  $("#daterange-btnCotizaciones").on(
    ...
    function (ev, picker) {
      ...
      window.location = "index.php?ruta=adminCoti";
  ...
  $.ajax({
    ...
    success: function (respuesta) {
      ...
      if(respuesta["cot_placa"] == "WWW404"){
          respuesta["cot_placa"] = "SIN PLACA - VEHÍCULO 0 KM"
      }
            ...
            respuesta.forEach(function (oferta, i) {
              ...
              cardCotizacion += `
                      ...
                      <div class='col-12' style='margin-top:2%;'>
                          ${((oferta.Aseguradora === "Liberty" || oferta.Aseguradora === "Equidad" || oferta.Aseguradora === "Mapfre") && id_intermediario == "78") ?
                            `<center>
