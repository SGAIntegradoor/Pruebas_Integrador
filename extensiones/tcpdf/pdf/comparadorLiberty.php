...
while ($rowRespuesta4 = mysqli_fetch_assoc($respuestaquery4)) {
	...
	if ($cont % 2 == 0) {
		...
		} else if ($rowRespuesta4['Aseguradora'] == 'Zurich') {
			$html2 .= '<td class="puntos td2 fondo2">
			<div style="font-size:5pt">&nbsp;</div>
			<img style="width:35px;" src="../../../vistas/img/logos/zurich.png" alt="">
			<div style="font-size:5pt">&nbsp;</div>
		...
		} else if ($rowRespuesta4['Aseguradora'] == 'Mapfre') {
			$html2 .= '<td class="puntos td2 fondo2">
			<div style="font-size:5pt">&nbsp;</div>
			<img style="width:35px;" src="../../../vistas/img/logos/mapfre.png" alt="">
			<div style="font-size:5pt">&nbsp;</div>
...
while ($rowRespuesta11 = mysqli_fetch_assoc($respuestaquery11)) {
	...
	if ($cont7 % 2 == 0) {
		$html3 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuesta11['PerdidaParcial'] . '</font></center></td>';
	} else {
		$html3 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuesta11['PerdidaParcial'] . '</font></center></td>';
	}
...
while ($rowRespuesta12 = mysqli_fetch_assoc($respuestaquery12)) {
	...
	if ($cont8 % 2 == 0) {
		$html3 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuesta12['PerdidaParcial'] . '</font></center></td>';
	} else {
		$html3 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuesta12['PerdidaParcial'] . '</font></center></td>';
	}
...
while ($rowRespuesta13 = mysqli_fetch_assoc($respuestaquery13)) {
	...
	if ($cont9 % 2 == 0) {
		$html3 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuestaAsistencia5['eventos'] . '</font></center></td>';
	} else {
		$html3 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><font size="7"style="text-align: center;  font-family:dejavusanscondensed;"><div style="font-size:4pt">&nbsp;</div>' . $rowRespuestaAsistencia5['eventos'] . '</font></center></td>';
	}
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//CONSULTA ASISTENCIA JURIDICA EN PROCESO PENAL
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
$html4 .= '<table>';
...
while ($rowRespuesta17 = mysqli_fetch_assoc($respuestaquery17)) {
	...
	if ($cont13 % 2 == 0) {
		if ($rowRespuestaAsistencia9['amparopatrimonial'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center;">' . $rowRespuestaAsistencia9['amparopatrimonial'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia9['amparopatrimonial'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center;">' . $rowRespuestaAsistencia9['amparopatrimonial'] . '</font></center></td>';
		}
	}
...
while ($rowRespuesta27 = mysqli_fetch_assoc($respuestaquery27)) {
	...
	if ($cont14 % 2 == 0) {
		if ($rowRespuestaAsistencia10['Gastosdetransportept'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia10['Gastosdetransportept'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia10['Gastosdetransportept'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia10['Gastosdetransportept'] . '</font></center></td>';
		}
	}
...
$cont21 = 1;
while ($rowRespuesta23 = mysqli_fetch_assoc($respuestaquery23)) {
	...
	if ($cont21 % 2 == 0) {
		...
		// } else {
		$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $ampara . '</font></center></td>';
		// }
	} else {
		// if ($rowRespuestaAsistencia17['ResponsabilidadCivilGeneralFamiliar'] == "Si ampara") {
		// $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		// } else {
		$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $ampara . '</font></center></td>';
	}
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//CONSULTA ACCIDENTES PERSONALES PRUEBA
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
$html4 .= '<tr>';
$html4 .= '<td class ="fondo puntos" style="width:10%; text-align: center; font-family:dejavusanscondensedb;"><font size="8">Cobertura vidrios</font></td>';
// $html4 .= '</table>';
...
while ($rowRespuesta24 = mysqli_fetch_assoc($respuestaquery24)) {
	...
	if ($cont22 % 2 == 0) {
		...
		// $html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		// } else {
		$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%; text-align: center"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia18['CoberturaDeVidrios'] . '</font></center></td>';
		// }
	} else {
		// if ($rowRespuestaAsistencia18['CoberturaDeVidrios'] == "Si ampara") {
		// $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		// } else {
		$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%; text-align: center"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia18['CoberturaDeVidrios'] . '</font></center></td>';
		// }
	}
...
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
//CONSULTA Asistencia Juridica Civil
//::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
$html4 .= '<table>';
$html4 .= '<tr>';
$html4 .= '<td class ="fondo puntos" style="width:10%; text-align: center; font-family:dejavusanscondensedb;"><div style="font-size:4pt">&nbsp;</div><font size="8">Asistencia odontológica</font></td>';
...
while ($rowRespuesta26 = mysqli_fetch_assoc($respuestaquery26)) {
	...
	if ($cont24 % 2 == 0) {
		if ($rowRespuestaAsistencia20['AsistenciaOdontologica'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia20['AsistenciaOdontologica'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia20['AsistenciaOdontologica'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia20['AsistenciaOdontologica'] . '</font></center></td>';
		}
	}
...
$html4 .= '<table>';
$html4 .= '<tr>';
$html4 .= '<td class ="fondo puntos" style="width:10%; text-align: center; font-family:dejavusanscondensedb;"><center><div style="font-size:7pt">&nbsp;</div><font size="8">Exequias</font></center></td>';
...
while ($rowRespuesta27 = mysqli_fetch_assoc($respuestaquery27)) {
	...
	$queryConsultaAsistencia21 = "SELECT * FROM asistencias WHERE `aseguradora` LIKE '$nombreAseguradora' AND `producto` LIKE '$nombreProducto'";
	...
	if ($cont25 % 2 == 0) {
		if ($rowRespuestaAsistencia21['exequias'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia21['exequias'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia21['exequias'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia21['exequias'] . '</font></center></td>';
		}
	}
...
while ($rowRespuesta28 = mysqli_fetch_assoc($respuestaquery28)) {
	...
	if ($cont26 % 2 == 0) {
		if ($rowRespuestaAsistencia22['Asesoria_Gestion_de_tramites'] == "Si ampara") {
			...
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['Asesoria_Gestion_de_tramites'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia22['Asesoria_Gestion_de_tramites'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['Asesoria_Gestion_de_tramites'] . '</font></center></td>';
		}
	}
...
while ($rowRespuesta28 = mysqli_fetch_assoc($respuestaquery28)) {
	...
	if ($cont26 % 2 == 0) {
		if ($rowRespuestaAsistencia22['AsistenciaViajes'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['AsistenciaViajes'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia22['AsistenciaViajes'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:14pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['AsistenciaViajes'] . '</font></center></td>';
		}
	}
...
$query28 = "SELECT * FROM ofertas WHERE `id_cotizacion` = $identificador AND `seleccionar` = 'Si'";
$respuestaquery28 =  $conexion->query($query28);
$respuesta1 = "Hasta $2.500.000";
$cont26 = 1;
while ($rowRespuesta28 = mysqli_fetch_assoc($respuestaquery28)) {

    $PT = $rowRespuesta28['PerdidaTotal'];
    $nombreAseguradora = nombreAseguradora($rowRespuesta28['Aseguradora']);
    $nombreProducto = productoAseguradora($rowRespuesta28['Aseguradora'], $rowRespuesta28['Producto']);
    ...
    if ($cont26 % 2 == 0) {
        if ($PT == "Deducible: 10% min 1.2 SMMLV" || $PT == "Deducible: 10% min 1 SMMLV") {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $respuesta1 . '</font></center></td>';
        } else {
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                $html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
            } else {
                $html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:6pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    } else {
        if ($PT == "Deducible: 10% min 1 SMMLV" || $PT == "Deducible: 10% min 1.2 SMMLV") {			
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $respuesta1 . '</font></center></td>';
        } else {
            if ($rowRespuestaAsistencia22['GastosMedicos'] == "Si ampara") {
                $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:12pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
            } else {
                $html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:6pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['GastosMedicos'] . '</font></center></td>';
            }
        }
    }
...
while ($rowRespuesta28 = mysqli_fetch_assoc($respuestaquery28)) {
	...
	if ($cont26 % 2 == 0) {
		if ($rowRespuestaAsistencia22['LucroCesante'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['LucroCesante'] . '</font></center></td>';
		}
	} else {
		if ($rowRespuestaAsistencia22['LucroCesante'] == "Si ampara") {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><div style="font-size:6pt">&nbsp;</div><img style="width:16px;" src="../../../vistas/img/logos/cheque.png" alt=""></td>';
		} else {
			$html4 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;"><center><div style="font-size:7pt">&nbsp;</div><font size="7"style="text-align: center; font-family:dejavusanscondensed;">' . $rowRespuestaAsistencia22['LucroCesante'] . '</font></center></td>';
		}
	}
...
// $html5 .= '<table style="width: 100%;" class="second2" cellpadding="2"  border="0">';
...
// 	if ($cont3 % 2 == 0) {
// 		if ($rowRespuesta23['Aseguradora'] == 'Axa Colpatria') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;"><center>
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/axa.png" alt=""></center>
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Seguros del Estado') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/estado.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'HDI Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/hdi.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'SBS Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/sbs.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Seguros Bolivar') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/bolivar.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Seguros Sura') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/sura.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Zurich Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/zurich.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Zurich') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/zurich.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Allianz Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/allianz.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Allianz') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/allianz.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Liberty Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/liberty.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Liberty') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/liberty.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Seguros Mapfre') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/mapfre.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Mapfre') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/mapfre.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Equidad Seguros') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/equidad.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
...
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Previsora') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/previsora.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Aseguradora Solidaria') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/solidaria.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			</td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Solidaria') {
// 			$html5 .= '<td class="puntos fondo" style="width:' . $valorTabla . '%;text-align: center;">
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/solidaria.png" alt="">
// 			<div style="font-size:5pt">&nbsp;</div>
...
// 	} else {
// 		if ($rowRespuesta23['Aseguradora'] == 'Axa Colpatria') {
// 			$html5 .= '<td class="puntos fondo2" style="width:' . $valorTabla . '%;text-align: center;"><center>
// 			<div style="font-size:5pt">&nbsp;</div>
// 			<img style="width:35px;" src="../../../vistas/img/logos/axa.png" alt=""></center></td>';
// 		} else if ($rowRespuesta23['Aseguradora'] == 'Seguros del Estado') {
...
while ($rowRespuesta29 = mysqli_fetch_assoc($respuestaquery29)) {
	...
	// die();
	// echo "Nombre de Aseguradora primera consulta: " . $nombreAseguradora1 . "<br>";
...
// $pdf->SetTextColor(104, 104, 104);
// $pdf->SetXY(100, 18);
// $pdf->Cell(10, 0, 'Si ya escogiste una Aseguradora, ', 0, $ln = 0, 'C', 0, '', 0, false, 'C', 'C');
...
// $pdf->SetTextColor(104, 104, 104);
// $pdf->SetXY(56, 26);
// $pdf->Cell(10, 0, 'Estos son los ', 0, $ln = 0, 'C', 0, '', 0, false, 'C', 'C');


// $pdf->SetFont('dejavusanscondensed', 'B', 15);
// $pdf->SetTextColor(0, 0, 0);
// $pdf->SetXY(84, 26);
// $pdf->Cell(10, 0, ' 5 PASOS ', 0, $ln = 0, 'C', 0, '', 0, false, 'C', 'C');
...
// $pdf->SetTextColor(104, 104, 104);
// $pdf->SetXY(128, 26);
// $pdf->Cell(10, 0, ' para asegurar tu vehículo ', 0, $ln = 0, 'C', 0, '', 0, false, 'C', 'C');


// // $htmlimg = '<img src="../../../vistas/img/logos/pasosaseguradora.jpg">';
// // $pdf -> writeHTML($htmlimg, true, false, true, false, '');

// $pdf->Image('../../../vistas/img/logos/pasosaseguradora.jpg', 5, 30, 0, 92, 'JPG', '', '', true, 200, '', false, false, 0, false, false, false);
